...
class LocalidadesControllerTest < ActionController::TestCase
  ...
  test "should create localidad" do
    assert_difference('Localidad.count') do
      post :create, :localidad => { :deleted_at => @localidad.deleted_at, :municipio_id => @localidad.municipio_id, :nombre => @localidad.nombre }
    end
  ...
  test "should update localidad" do
    put :update, :id => @localidad, :localidad => { :deleted_at => @localidad.deleted_at, :municipio_id => @localidad.municipio_id, :nombre => @localidad.nombre }
    assert_redirected_to localidad_path(assigns(:localidad))
  end
